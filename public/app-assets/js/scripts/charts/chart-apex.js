...
$(function () {
  ...
  let states = JSON.parse($(lineChartEl).attr("data"))

  let labels = states.map(state => `${state.hours} H `);
        ...
        custom: function (data) {
          return (
            `<div class="px-1 py-50">
                <span>
                    ${data.series[data.seriesIndex][data.dataPointIndex]} Commandes
                </span>
            </div>`
          );
        }
...
//   var lineChartEl = document.querySelector('#line-chart1'),
//     lineChartConfig = {
//       chart: {
//         height: 400,
//         type: 'line',
