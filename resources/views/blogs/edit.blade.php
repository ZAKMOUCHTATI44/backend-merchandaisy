                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-md-12 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{$blog->title}}" class="form-control" name="titre" id="name" />
                                    <label>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="select2 form-control form-control-lg" name="category">
                                    @foreach ($tags as $tag)
                                        <option value={{$tag->id}}  @selected($blog->tag_id == $tag->id)>
                                            {{$tag->name}}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="time_of_read" id="time_of_read" value="{{$blog->time_of_read}}" />
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                            ...
                            <div class="col-12 mt-1">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="0" @checked(!$blog->is_active) />
                                    <label class="form-check-label" for="is_active">Caché le post </label>
                                </div>
                            </div>
                            <div class="col-md-12">
